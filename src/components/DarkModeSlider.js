  ...
  <div className="flex items-center space-x-4">
    <svg width="32" height="32" fill="none">
      ...
      <defs>
        ...
        >
          <stop className="transition-all duration-200" stopColor="#FACC15" />
          <stop
    ...
    <button
      style={{ backgroundColor: "#60D360" }}
      id="headlessui-switch-1"
      role="switch"
      tabIndex="0"
      className="inline-flex items-center px-0.5 rounded-full w-18 h-9 transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-white focus-visible:ring-gray-500 focus:outline-none"
      aria-checked="false"
    >
